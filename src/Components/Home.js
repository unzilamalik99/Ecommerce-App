  ...
  return (
    <>
      ...
      >
        ...
        <SwiperSlide>
          <div
            className="w-full h-screen bg-cover bg-center py-10"
            style={{
              backgroundImage:
            ...
            <div className=" px-10 pt-40 md:max-w-7xl mx-auto text-black font-bold">
              ...
              <div className="px-5  text-4xl md:text-6xl md:w-1/2 font-bold">
                <h1 className="font-italic item-center">
                  Summer Scale Has Started
                </h1>
              </div>
              <div className="pt-2 px-5 text-[#53b19c]   ">
                <h1 className="text-2xl md:text-3xl">UP to 70% OFF</h1>
                <button className="bg-sky-400 md:text-2xl px-4 py-3 mt-5 font-bold text-white rounded-xl hover:bg-black hover:text-white ">
                  Shop now
                </button>
              </div>
            </div>
        ...
        <SwiperSlide>
          ...
          >
            ...
            <div className=" px-10 pt-40 md:max-w-7xl mx-auto text-black font-bold">
              ...
              <div className="pt-2 px-5 text-[#53b19c]">
                <h1 className="text-2xl md:text-3xl">UP to 70% OFF</h1>
                <button className="bg-sky-400 md:text-2xl px-4 py-3 mt-5 font-semibold text-white  rounded-xl hover:bg-black hover:text-white ">
                  Shop now
                </button>
              </div>
            </div>
